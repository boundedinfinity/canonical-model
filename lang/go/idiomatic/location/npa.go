...
func NpaCodeLookup(s string) (NpaCode, bool) {
	...
	if numeric, err := strconv.Atoi(lower); err == nil {
		if code, ok := npa_numeric2Code[numeric]; ok {
			return code, true
		}
	}

	return NpaCode{}, false
}

func init() {
	for _, line := range stringer.Split(npaLocationCsv, "\n") {
		...
		code := NpaCode{}
		numeric, _ := strconv.Atoi(fields[0])
		code.Alpha2 = fields[1]
...
var (
	NpaCodes         = []NpaCode{}
	npa_numeric2Code = map[int]NpaCode{}
	npa_alpha22Code  = map[string]NpaCode{}
    ...
    780,ALBERTA,
    781,MA,
    782,NOVA SCOTIA - PRINCE EDWARD ISLAND,
