...
func pred(s string) func(NameOrdering) bool {
	return func(v NameOrdering) bool {
		return string(v) == s
	}
}
...
func Parse(v string) (NameOrdering, error) {
...
func Is(s string) bool {
	return slices.ContainsFn(All, func(v NameOrdering) bool {
		return string(v) == s
	})
}
