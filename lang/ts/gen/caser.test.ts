...
Deno.test("pascal to phrase", () => {
  ...
  assertEquals(
    caser.pascal2phrase("APhraseWithOtherWords"),
    "a Phrase With Other Words",
  );
  assertEquals(caser.pascal2phrase(" "), "");
  assertEquals(
    caser.pascal2phrase("1PhraseWithOtherWords"),
    "1 Phrase With Other Words",
  );
});
...
Deno.test("camel to phrase", () => {
  const caser = new Caser();
  assertEquals(
    caser.camel2phrase("aPhraseWithOtherWords"),
    "A Phrase With Other Words",
  );
  assertEquals(caser.camel2phrase(" "), "");
  assertEquals(
    caser.camel2phrase("1PhraseWithOtherWords"),
    "1 Phrase With Other Words",
  );
});
